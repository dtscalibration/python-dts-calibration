...
.. parsed-literal::
    ...
    Data variables:
        ...
        TMPF_MC                (CI, x, time) float64 16.04 16.31 15.56 15.82 ...
        TMPB_MC                (CI, x, time) float64 15.45 15.69 15.62 15.48 ...
        TMPF_MC_var            (x, time) float64 0.1528 0.1485 0.1664 0.1416 ...
        TMPB_MC_var            (x, time) float64 0.4325 0.3948 0.4232 0.3987 ...
