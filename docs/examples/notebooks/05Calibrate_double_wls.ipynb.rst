...
.. parsed-literal::
    ...
    Data variables:
        ...
        TMPF_MC                (CI, x, time) float64 16.02 16.31 15.6 15.82 ...
        TMPB_MC                (CI, x, time) float64 15.63 15.59 15.57 15.33 ...
        TMPF_MC_var            (x, time) float64 0.1516 0.1388 0.1604 0.1493 ...
        TMPB_MC_var            (x, time) float64 0.3715 0.383 0.4338 0.3996 ...
